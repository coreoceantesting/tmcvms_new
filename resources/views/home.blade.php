        ...
        <div class="row">
            <div class="col">
                <div class="card border-info mb-3">
                    <div class="card-body">
                        <b><p class="text-center" style="margin-bottom: 0rem;" id="currentDateTime"></p></b>
                    </div>
                </div>
            </div>
        </div><br>
       ...
       <div class="row">
            <div class="col">
                <div class="card border-dark mb-3" >
                    ...
                    <p class="card-text text-center" style="font-size: xx-large;">{{$todayEntryVisitorsCount}}</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border-dark mb-3">
                    ...
                    <p class="card-text text-center" style="font-size: xx-large;">{{$todayExitVisitorsCount}}</p>
                    </div>
                </div>
            </div>
       </div>
...
<script>
    function updateDateTime() {
        ...
        const now = new Date();
        const formattedDateTime = now.toLocaleString(); // Change the format as needed
